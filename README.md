...
I provide here a Bash script (`gajim-macos-helper.sh`) to help creating virtual environments for nbxmpp and Gajim in Mac OS, build it, start it from the virtual environement, and also create a `.dmg` bundle.
...
> Warning: At this time, the produced `.dmg` file is still not working properly. I try to figure it out.
